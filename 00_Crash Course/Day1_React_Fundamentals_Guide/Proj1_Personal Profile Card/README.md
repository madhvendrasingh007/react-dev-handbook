...
### Challenge 1: Add More Props ⭐
Add these new features:
- `location` (City, Country)
- `email` (Email address)
- Social media links

**Hint:** Add new props to ProfileCard component

### Challenge 2: Add Buttons ⭐⭐
Add interactive buttons:
- "View Profile" button
- "Contact Me" button

**Hint:** Use `<button>` tags in JSX

### Challenge 3: Use Your Own Data ⭐
Replace placeholder images with:
- Your own photo
- Your own name and bio
- Make it personal!

### Challenge 4: Dark Mode Toggle ⭐⭐⭐
Add a button to switch between light and dark mode

**Hint:** You'll need to learn about useState (coming in Day 2!)

### Challenge 5: Hover Effects ⭐⭐
Add creative hover effects:
- Image zoom on hover
- Color changes
- Smooth transitions

**Hint:** Use CSS `:hover` pseudo-class
...
**Error:**
```
Cannot find module './components/ProfileCard'
```

**Solution:**
- Check file path spelling
- Make sure ProfileCard.jsx exists
...
- Use correct import: `import profileImg from './assets/profile.jpg'`

---

### Issue 3: Styles Not Applied

**Error:** Component looks unstyled

**Solution:**
- Make sure you imported CSS: `import './ProfileCard.css'`
- Check className spelling
- Inspect element in browser DevTools

---

### Issue 4: "Props is undefined"

**Error:** Can't read properties of undefined

**Solution:**
- Make sure you're passing props: `<ProfileCard name="..." />`
- Check prop names match (case-sensitive!)
- Use default values: `function ProfileCard({ name = "Guest" })`
...
### Community
- [React Discord](https://discord.gg/react) - Join React community
- [Stack Overflow](https://stackoverflow.com/questions/tagged/reactjs) - Ask questions

---

## 🎉 Congratulations!

You just built your first React project! 🎊
...
- ✅ Wrote JSX
- ✅ Styled a component
- ✅ Used components in your app

### Next Steps:
1. **Experiment** - Change colors, sizes, add features
2. **Practice** - Build more profile cards
3. **Share** - Show your project to friends
4. **Learn More** - Move to Day 2 (State & Events)
